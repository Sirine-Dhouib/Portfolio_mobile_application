...
import 'widgets/technologies_i_worked_with_widget.dart';
import 'widgets/education_widget.dart';
import 'widgets/professionalexperiences_widget.dart';

class MobileAboutSectionView extends StatelessWidget {
  const MobileAboutSectionView({super.key, required this.aboutKey});
