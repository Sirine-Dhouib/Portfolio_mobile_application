  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          'I\'m virtual person, a Flutter Developer and AI Engineer.',
